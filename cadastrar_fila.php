<?php
	$pageTitle = "Cadastro de Fila | BIBLIOIECP";
...
?>
	<form action = 'inserir_fila' autocomplete = 'off' enctype = 'multipart/form-data' method = POST name = 'incInserirFila'>
		<h2>CADASTRO DE FILA</h2><br>
